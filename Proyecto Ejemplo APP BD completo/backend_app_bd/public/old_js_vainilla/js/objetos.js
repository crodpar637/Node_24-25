...
class Empresa {
    ...
    async buscarTipo(idTipo) {
        let datos = new FormData();

        // datos.append("idtipo", idTipo);  // Sobra, el id va en la ruta

        let respuesta = await peticionGET(`/tipos/${idTipo}`, datos);
    ...
    async borrarTipo(idTipo) {
        console.log("idTipo a borrar:", idTipo);
        let respuesta = await peticionDELETE(`/tipos/${idTipo}`);
